...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final MkergallLibraryAccessors laccForMkergallLibraryAccessors = new MkergallLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>ble</b> with <b>no.nordicsemi.android:ble</b> coordinates and
     * with version reference <b>ble</b>
     * <p>
    ...
    /**
     * Dependency provider for <b>console</b> with <b>com.jraska:console</b> coordinates and
     * with version reference <b>console</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
    ...
    /**
     * Dependency provider for <b>mapscore</b> with <b>io.openmobilemaps:mapscore</b> coordinates and
     * with version reference <b>mapscore</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getMapscore() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("mapscore");
    }

    /**
     * Dependency provider for <b>mgrs</b> with <b>mil.nga:mgrs</b> coordinates and
     * with version reference <b>mgrs</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getMgrs() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("mgrs");
    }
    ...
    /**
     * Group of libraries at <b>mkergall</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public MkergallLibraryAccessors getMkergall() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForMkergallLibraryAccessors;
    }
    ...
    public static class AndroidxLifecycleRuntimeKtxLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public Provider<MinimalExternalModuleDependency> getV270() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.lifecycle.runtime.ktx.v270");
        }
    ...
    public static class FragmentLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>ktx</b> with <b>anroidx.fragment:fragment-ktx</b> coordinates and
    ...
    public static class MaterialLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v150alpha04</b> with <b>com.google.android.material:material</b> coordinates and
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getV150alpha04() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("material.v150alpha04");
        }
     ...
     */
    @Deprecated
    public static class MkergallLibraryAccessors extends SubDependencyFactory {

        public MkergallLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>osmbonuspack</b> with <b>com.github.MKergall:osmbonuspack</b> coordinates and
         * with version reference <b>osmbonuspackVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getOsmbonuspack() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("mkergall.osmbonuspack");
        }
    ...
    public static class OsmdroidLibraryAccessors extends SubDependencyFactory {
        private final OsmdroidOsmdroidLibraryAccessors laccForOsmdroidOsmdroidLibraryAccessors = new OsmdroidOsmdroidLibraryAccessors(owner);
         ...
         * with version reference <b>osmdroidWms</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        /**
         * Group of libraries at <b>osmdroid.osmdroid</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public OsmdroidOsmdroidLibraryAccessors getOsmdroid() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForOsmdroidOsmdroidLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class OsmdroidOsmdroidLibraryAccessors extends SubDependencyFactory {

        public OsmdroidOsmdroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>org.osmdroid:osmdroid-android</b> coordinates and
         * with version reference <b>osmdroidAndroidVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("osmdroid.osmdroid.android");
        }
    ...
    public static class SdkLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>full</b> with <b>ru.dgis.sdk:sdk-full</b> coordinates and
         * with version reference <b>sdkFull</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>ble</b> with value <b>2.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getBle() { return getVersion("ble"); }
        ...
        /**
         * Version alias <b>console</b> with value <b>1.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getConsole() { return getVersion("console"); }
        ...
        /**
         * Version alias <b>lifecycleRuntimeKtxVersion</b> with value <b>2.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>mapscore</b> with value <b>3.0.0-rc.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMapscore() { return getVersion("mapscore"); }
        ...
        /**
         * Version alias <b>materialVersion</b> with value <b>1.5.0-alpha04</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>mgrs</b> with value <b>2.1.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMgrs() { return getVersion("mgrs"); }
        ...
        /**
         * Version alias <b>osmbonuspackVersion</b> with value <b>6.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getOsmbonuspackVersion() { return getVersion("osmbonuspackVersion"); }

        /**
         * Version alias <b>osmdroidAndroidVersion</b> with value <b>6.1.14</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getOsmdroidAndroidVersion() { return getVersion("osmdroidAndroidVersion"); }

        /**
         * Version alias <b>osmdroidWms</b> with value <b>6.1.14</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getOsmdroidWms() { return getVersion("osmdroidWms"); }
        ...
        /**
         * Version alias <b>sdkFull</b> with value <b>latest.release</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSdkFull() { return getVersion("sdkFull"); }
